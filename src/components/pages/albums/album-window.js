...
class AlbumWindow extends React.Component {
  ...
  openArtist(artistId) {
    this.props.closeAlbumWindow()
    this.props.openArtistWindow(artistId)
  }
        ...
        <div className="container-fluid">
          <div className="row">
            ...
            <div className="col-sm-9 album-window-side album-window-info">
              ...
              <h2>
                <span onClick={ obj => this.openArtist(props.album.artistId) }>{props.album.artistName}</span> &#8211; {props.album.year} &#8211; {props.album.numSongs} track{albumTrackNum}
              </h2>
